...
public class ModBlocks {
    ...
    public static final Block POTTED_ROSE = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_classic_rose"),
    ...
    public static final Block CYAN_ROSE = registerBlock("cyan_rose",
            new FlowerBlock(StatusEffects.HERO_OF_THE_VILLAGE,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_CYAN_ROSE = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_cyan_rose"),
    ...
    public static final Block WHITE_CHRYSANTHEMUM = registerBlock("white_chrysanthemum",
            new FlowerBlock(StatusEffects.SLOW_FALLING,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_WHITE_CHRYSANTHEMUM  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_white_chrysanthemum"),
    ...
    public static final Block PINK_CHRYSANTHEMUM = registerBlock("pink_chrysanthemum",
            new FlowerBlock(StatusEffects.SLOW_FALLING,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_PINK_CHRYSANTHEMUM  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_pink_chrysanthemum"),
    ...
    public static final Block YELLOW_CHRYSANTHEMUM = registerBlock("yellow_chrysanthemum",
            new FlowerBlock(StatusEffects.SLOW_FALLING,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_YELLOW_CHRYSANTHEMUM  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_yellow_chrysanthemum"),
    ...
    public static final Block RED_COCKSCOMB = registerBlock("red_cockscomb",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_RED_COCKSCOMB  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_red_cockscomb"),
    ...
    public static final Block YELLOW_COCKSCOMB = registerBlock("yellow_cockscomb",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_YELLOW_COCKSCOMB  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_yellow_cockscomb"),
    ...
    public static final Block PURPLE_COCKSCOMB = registerBlock("purple_cockscomb",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_PURPLE_COCKSCOMB  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_purple_cockscomb"),
    ...
    public static final Block PINK_COCKSCOMB = registerBlock("pink_cockscomb",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_PINK_COCKSCOMB  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_pink_cockscomb"),
    ...
    public static final Block SILVER_COCKSCOMB = registerBlock("silver_cockscomb",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_SILVER_COCKSCOMB  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_silver_cockscomb"),
    ...
    public static final Block BIRD_PARADISE= registerBlock("bird_of_paradise",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_BIRD_PARADISE  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_bird_paradise"),
    ...
    public static final Block FALSE_SHAMROCK= registerBlock("false_shamrock",
            new FlowerBlock(StatusEffects.ABSORPTION,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_FALSE_SHAMROCK  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_false_shamrock"),
    ...
    public static final Block POTTED_HIDRANGEA  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_hidrangea"),
    ...
    public static final Block WEIGELA= registerBlock("weigela",
            new FlowerBlock(StatusEffects.HEALTH_BOOST,1,
                    AbstractBlock.Settings.copy(Blocks.POPPY).nonOpaque().noCollision()));
    public static final Block POTTED_WEIGELA  = Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, "potted_weigela"),
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(KawaFlora.MOD_ID, name), block);
    }
    private static Item registerBlockItem(String name, Block block){
        return Registry.register(Registries.ITEM, Identifier.of(KawaFlora.MOD_ID, name),
