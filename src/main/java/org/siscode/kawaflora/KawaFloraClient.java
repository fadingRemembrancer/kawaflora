...
public class KawaFloraClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        //CHRYSANTHEMUMS
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.YELLOW_CHRYSANTHEMUM, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_YELLOW_CHRYSANTHEMUM, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.PINK_CHRYSANTHEMUM, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_PINK_CHRYSANTHEMUM, RenderLayer.getCutout());
        //
